...
//           backgroundSize: "contain", // 填滿畫面
//           backgroundPosition: "center",
//           backgroundRepeat: "no-repeat",
//         }}></div>

//       {/* 添加文字 - 頂部 */}
//       <div className='absolute top-0 left-0 w-full flex flex-col items-center pt-80'>
...
//       {/* 老虎機容器 - 精確對齊白色方框 */}
//       <div
//         className={`absolute top-[40%] left-1/2 -translate-x-1/2 w-full max-w-[2000px] pt-10 ${
...
//             <div
//               key={index}
//               className='grid grid-cols-4 gap-4 text-center text-4xl py-8 border-b border-gray-300'>
...
//                 <Button
//                   variant='secondary'
//                   className='text-4xl py-4 px-8 h-16 w-48 tracking-widest'
